...
template<typename T>
void M(T msg, bool disableNewline = 0) { if(!devMode || !showDevMessages || 0) {return;} cout << msg; if(!disableNewline) { cout << endl; } }

//particularly for errors
template<typename T>
void E(T msg, bool disableNewline = 0) { if(!devMode || !showErrorMessages || 0) {return;} cout << "ERROR: " << msg; if(!disableNewline) { cout << endl; } }

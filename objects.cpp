...
tile::tile(SDL_Renderer * renderer, const char* filename, const char* mask_filename, int fx, int fy, int fwidth, int fheight, int flayer, bool fwrap, bool fwall, float fdxoffset, float fdyoffset) {
  ...
  fileaddress = fileaddress.substr(0, fileaddress.find_last_of('.'))+".png";

  filename = fileaddress.c_str();
...
attack::attack(string filename, bool tryToShareTextures) {
  ...
  string temp;
  temp = "resources/static/sprites/" + spritename + ".png";
...
effectIndex::effectIndex(string filename, SDL_Renderer* renderer) {
  ...
  if(1) {
    existSTR = "resources/static/sprites/" + texname + ".png";
...
indexItem::indexItem(string fname, bool fisKeyItem) : name(fname), isKeyItem(fisKeyItem) {
  ...
  lstr = "resources/static/items/" + fname + "-inv.png";
...
entity::entity(SDL_Renderer * renderer, string filename, float sizeForDefaults) {
  ...
  spritefilevar = "resources/static/sprites/" + temp + ".png";

  if(temp == "sp-no-texture") {
    spritefilevar = "resources/engine/sp-no-texture.png";
  }
...
entity::entity(SDL_Renderer * renderer, int idk,  string texturename) {
  ...
  spritefilevar = "resources/static/items/" + texturename + ".png";
  

  if(onionmode) {spritefilevar = "resources/engine/onion.png";}
...
levelNode::levelNode(string p3, string p4, string p5, SDL_Renderer * renderer, int fmouthStyle, int ffloors, vector<string> fbehemoths, int ffirstfloor, int frestlen, int fchaselen, string fmusic, string fchasemusic) {
  ...
  string loadSTR = "resources/levelsequence/icons/" + lowerName + ".png";
  ...
  if(eyeTexture == nullptr) {
    string loadSTR = "resources/levelsequence/icons/eyes.png";
    this->eyeTexture = loadTexture(renderer, loadSTR);
  }

  if(mouthTexture == nullptr) {
    string loadSTR = "resources/levelsequence/icons/mouth2.png";
    if(mouthStyle == 1) {
      loadSTR = "resources/levelsequence/icons/mouth.png";
    }
...
usable::usable(string fname) {
  ...
  //load sprite
  loadstr = filepath + "img_" + fname + ".png";
...
escapeUI::escapeUI() {
  ...
  ninePatch = new ui(renderer, "resources/static/ui/menu9patchblack.png", xStart, yStart, xEnd-xStart + 0.05, yEnd-yStart + 0.05, 0);
  ...
  handMarker = new ui(renderer, "resources/static/ui/hand_selector.png", markerHandX, 0.1, markerWidth, 1, 2);
  ...
  fingerMarker = new ui(renderer, "resources/static/ui/finger_selector_angled.png", markerFingerX, 0.1, markerWidth, 1, 2);
...
//    backButton = new ui(renderer, "resources/static/ui/menu_back.png", bbXStart, bbYStart, bbWidth, 1, 2);
...
//
//    bbNinePatch = new ui(renderer, "resources/static/ui/menu9patchblack.png", bbXStart, bbYStart, bbWidth, 1, 0);
...
void clear_map(camera& cameraToReset) {
  ...
  if(!g_levelFlashing){
    ...
    SDL_Surface* transitionSurface = loadSurface("resources/engine/transition.png");
...
adventureUI::adventureUI(SDL_Renderer *renderer, bool plight) //a bit strange, but due to the declaration plight is 0 by default
{
  this->light = plight;
  if(!light) {
    talkingBox = new ui(renderer, "resources/static/ui/menu9patchblack.png", 0, 0.65, 1, 0.35, 0);
    talkingBox->patchwidth = 213;
    talkingBox->patchscale = 0.4;
    talkingBox->is9patch = true;
    talkingBox->persistent = true;

    dialogProceedIndicator = new ui(renderer, "resources/static/ui/dialog_proceed.png", 0.92, 0.88, 0.05, 1, 0);
    ...
    // talkingBoxTexture = new ui(renderer, "resources/static/ui/ui-background.png", 0.1, 0.45, 0.9, 0.25, 0);
    ...
    inventoryA = new ui(renderer, "resources/static/ui/menu9patchblack.png", 0.01, 0.01, 0.98, 0.75 - 0.01, 1);
    ...
    inventoryB = new ui(renderer, "resources/static/ui/menu9patchblack.png", 0.01, 0.75 + 0.01, 0.98, 0.25 - 0.02, 1);
    ...
    crosshair = new ui(renderer, "resources/static/ui/crosshair.png", 0, 0, 0.05, 0.05, -15);
    ...
    b0_element = new ui(renderer, "resources/static/ui/behemoth_element.png", 0, 0, 0.05, 0.05, -15);
    ...
    b1_element = new ui(renderer, "resources/static/ui/behemoth_element.png", 0, 0, 0.05, 0.05, -15);
    ...
    b2_element = new ui(renderer, "resources/static/ui/behemoth_element.png", 0, 0, 0.05, 0.05, -15);
    ...
    b3_element = new ui(renderer, "resources/static/ui/behemoth_element.png", 0, 0, 0.05, 0.05, -15);
    ...
    hearingDetectable = new ui(renderer, "resources/static/ui/detection-hearing.png", 0.85, 0.05, 0.1, 1, -10);
    ...
    seeingDetectable = new ui(renderer, "resources/static/ui/detection-seeing.png", 0.85, 0.075, 0.1, 1, -10);
...
//    tastePicture = new ui(renderer, "resources/static/ui/taste.png", 0.2 + 0.01, 1-0.1, 0.05, 1, -15);
...
//    hungerPicture = new ui(renderer, "resources/static/ui/hunger.png", 0.8, 0.6, 0.25, 1, -15);
...
//  healthPicture = new ui(renderer, "resources/static/ui/health.png", -0.04, -0.09, 0.25, 1, -15);
...
//  healthPicture->priority = -10; //health is behind everything
  ...
  hotbar = new ui(renderer, "resources/static/ui/menu9patchblack.png", g_hotbarX + g_backpackHorizontalOffset, 0.84, 0.1, 0.1, 1);
  ...
  hotbarFocus = new ui(renderer, "resources/static/ui/hotbar_focus.png", g_hotbarX + g_backpackHorizontalOffset + 0.005, 0.84 + 0.005, 0.1-0.01, 0.1-0.01, 1);
  hotbarFocus->persistent = true;
  hotbarFocus->heightFromWidthFactor = 1;
  hotbarFocus->priority = -7;
  hotbarFocus->dropshadow = 1;

  noIconTexture = loadTexture(renderer, "resources/engine/sp-no-texture.png");

  nextUsableIcon = new ui(renderer, "resources/engine/sp-no-texture.png", 0.45 + 0.1, 0.84, 0.1, 1, 1);
  ...
  prevUsableIcon = new ui(renderer, "resources/engine/sp-no-texture.png", 0.45 - 0.1, 0.84, 0.1, 1, 1);
  ...
  thisUsableIcon = new ui(renderer, "resources/static/ui/menu9patchblack.png", 0.45, 0.84, 0.1, 1, 1);
  ...
  t1 = new ui(renderer, "resources/static/ui/menu9patchblack.png", 0.45, 0.84, 0.1, 1, 1);
  t1->persistent = true;
  ...
  t2 = new ui(renderer, "resources/static/ui/menu9patchblack.png", 0.45, 0.84, 0.1, 1, 1);
  t2->persistent = true;
  ...
  t3 = new ui(renderer, "resources/static/ui/menu9patchblack.png", 0.45, 0.84, 0.1, 1, 1);
  t3->persistent = true;
  ...
  t4 = new ui(renderer, "resources/static/ui/menu9patchblack.png", 0.45, 0.84, 0.1, 1, 1);
  t4->persistent = true;
  ...
  t5 = new ui(renderer, "resources/static/ui/menu9patchblack.png", 0.45, 0.84, 0.1, 1, 1);
  t5->persistent = true;
  ...
  cooldownIndicator = new ui(renderer, "resources/engine/cooldownIndicator.png", g_hotbarX + g_backpackHorizontalOffset, 0.83, 0.03, 1, 1);
  ...
  hotbarMutedXIcon = new ui(renderer, "resources/static/ui/red_x.png", g_hotbarX + g_backpackHorizontalOffset + 0.005, 0.84 + 0.005, 0.1-0.01, 0.1-0.01, 1);
